# Generated by Powerlevel10k configuration wizard on 2026-05-07 at 15:08 +07.
...
() {
  ...
  # Display the current directory in bold.
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%203F'  # light red foreground
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      res+="${clean}%B${(g::)POWERLEVEL9K_VCS_BRANCH_ICON}${branch//\%/%%}%b"
    fi
